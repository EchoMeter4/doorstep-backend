...
class ZoneSeeder extends Seeder
{
    public function run(): void
    {
        $zones = [
            ...
            ['id' => 2,  'name' => 'Edificio B',            'description' => 'Departamento de operaciones',             'type' => 'mixed',      'enabled' => true],
            ...
            ['id' => 7,  'name' => 'Entrada Principal',     'description' => null, 'type' => 'mixed', 'enabled' => true],
            ['id' => 8,  'name' => 'Sala de Servidores',    'description' => null, 'type' => 'mixed', 'enabled' => true],
            ['id' => 9,  'name' => 'Estacionamiento',       'description' => null, 'type' => 'vehicular', 'enabled' => true],
            ['id' => 10, 'name' => 'Almacén',               'description' => null, 'type' => 'mixed', 'enabled' => true],
        ];
